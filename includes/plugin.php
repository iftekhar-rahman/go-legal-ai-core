...
final class Plugin {
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'search-product', plugins_url( '/assets/css/search-product.css', __FILE__ ) );

		wp_enqueue_style( 'swiper-bundle' );
		wp_enqueue_style( 'common-css' );
		wp_enqueue_style( 'search-product' );
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			...
			[
				...
				'title' => esc_html__( 'Go Legal Ai', 'go-legal-ai-addon' ),
				'icon' => 'fa fa-plug',
			]
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/search-product.php' );


		$widgets_manager->register( new \Go_Legal_Ai_Addon\Search_Product() );
